...
class TestSignalAttributionE2E:
    ...
    def test_jinja2_template_renders_signal_attribution(self):
        ...
        # 加载 Jinja2 模板
        template_path = os.path.join(os.path.dirname(__file__), '..', 'templates', 'report_markdown.j2')
        ...
        # 检查模板是否包含 signal_attribution 渲染代码
        assert 'signal_attribution' in template_content, "模板应包含 signal_attribution 渲染代码"
        assert 'technical_indicators' in template_content, "模板应包含 technical_indicators"
        assert 'news_sentiment' in template_content, "模板应包含 news_sentiment"
