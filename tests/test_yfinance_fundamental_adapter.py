...
class TestYfinanceFundamentalAdapter(unittest.TestCase):
    def test_populates_growth_earnings_dividend_boards_for_us_stock(self) -> None:
        ...
        # Use dates relative to "now" so the 365-day TTM window always contains
        # all 4 events regardless of when the test runs (fixes #2204).
        # Offsets are inside the 365-day window (60/150/240/330 days back).
