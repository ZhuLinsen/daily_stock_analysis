...
class AlphaVantageFetcher(BaseFetcher):
    ...
    def _is_us_stock(self, stock_code: str) -> bool:
        # Shared suffix-aware US check: excludes offshore suffix markets (e.g.
        # Canada `.V`) so a direct call never fetches US data for them.
        return is_us_market_symbol(stock_code)
