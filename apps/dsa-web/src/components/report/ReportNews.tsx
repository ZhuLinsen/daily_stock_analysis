...
const NEWS_SOURCE_TEXT = {
  ...
  de: {
    sourceLabel: 'Verwandte Nachrichten / Folgerecherche',
    sourceHint: 'Quelle: zusätzliche Nachrichten auf der Berichtsseite; die Analyse-Eingabe wird in den Eingabeblöcken angezeigt.',
  },
} as const;
