...
const MARKET_REVIEW_TEXT: Record<ReportLanguage, {
  ...
  de: {
    reviewSummary: 'Überblick',
    noReviewSummary: 'Noch keine Zusammenfassung',
    noSentimentScore: 'Noch keine Bewertung',
    rotationAndFunds: 'Rotation & Mittel',
    noRotationView: 'Noch keine Rotationsansicht',
    riskAndWatch: 'Risiken & Beobachtungen',
    noRiskWatch: 'Noch keine Kernbeobachtungen',
    structuredMarketData: 'Strukturierte Marktdaten',
    noBreadthData: 'Keine Daten',
    advancers: 'Gewinner',
    decliners: 'Verlierer',
    limitUpDown: 'Limit Up/Down',
    turnover: 'Umsatz',
    ...
    change: 'Veränderung',
    highLow: 'Hoch/Tief',
    industryBoards: 'Branchensektoren',
    conceptBoards: 'Konzeptthemen',
    leading: 'Führend',
    lagging: 'Nachzügler',
  },
};
