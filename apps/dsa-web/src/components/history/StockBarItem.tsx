...
export const StockBarItemComponent: React.FC<StockBarItemProps> = ({
  ...
  return (
    <div
      ...
      className={`home-history-item w-full min-w-0 flex-1 py-2 pr-2 text-left group/item ${showSelection ? 'pl-8' : 'pl-2'} ${
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0 flex-1">
              <span className="block w-full truncate text-[13px] font-semibold tracking-tight text-foreground">
