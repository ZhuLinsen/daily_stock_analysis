...
const TITLES: Record<string, { title: UiTextKey; description: UiTextKey }> = {
  ...
  '/journal': { title: 'layout.route.journal.title', description: 'layout.route.journal.description' },
  '/market-temperature': { title: 'layout.route.marketTemperature.title', description: 'layout.route.marketTemperature.description' },
  '/master-debate': { title: 'layout.route.masterDebate.title', description: 'layout.route.masterDebate.description' },
  '/virtual-trader': { title: 'layout.route.virtualTrader.title', description: 'layout.route.virtualTrader.description' },
