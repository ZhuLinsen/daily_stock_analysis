...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, HeartPulse, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'sentiment-review', labelKey: 'layout.nav.sentimentReview', to: '/sentiment-review', icon: HeartPulse },
