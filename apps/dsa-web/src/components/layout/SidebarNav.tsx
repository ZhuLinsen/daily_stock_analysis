...
import { Activity, BarChart3, Bell, BookOpen, BriefcaseBusiness, Gauge, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'research', labelKey: 'layout.nav.research', to: '/research', icon: BookOpen },
