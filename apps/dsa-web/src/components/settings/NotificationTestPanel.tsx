...
function getChannelOptions(language: UiLanguage): Array<{ value: NotificationTestChannel; label: string }> {
  // Channel brand names are language-neutral; de uses the English labels.
  const useEnglish = language !== 'zh';
  return [
    { value: 'wechat', label: useEnglish ? 'WeCom' : '企业微信' },
    { value: 'feishu', label: useEnglish ? 'Feishu Webhook' : '飞书 Webhook' },
    { value: 'dingtalk', label: useEnglish ? 'DingTalk' : '钉钉' },
    { value: 'telegram', label: 'Telegram' },
    { value: 'email', label: useEnglish ? 'Email' : '邮件' },
    { value: 'pushover', label: 'Pushover' },
    { value: 'ntfy', label: 'ntfy' },
    { value: 'gotify', label: 'Gotify' },
    { value: 'pushplus', label: 'PushPlus' },
    { value: 'serverchan3', label: 'ServerChan3' },
    { value: 'custom', label: useEnglish ? 'Custom Webhook' : '自定义 Webhook' },
