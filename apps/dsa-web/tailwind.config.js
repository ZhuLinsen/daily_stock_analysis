  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'primary-gradient': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.82) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 14px rgba(0, 212, 255, 0.16)',
        'glow-purple': '0 0 14px rgba(168, 85, 247, 0.14)',
        'glow-success': '0 0 20px rgba(0, 255, 136, 0.3)',
        'glow-danger': '0 0 20px rgba(255, 68, 102, 0.3)',
        'cyan/20': '0 10px 24px hsl(220 20% 28% / 0.14)',
        'cyan/22': '0 16px 32px hsl(220 20% 28% / 0.18)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 12px rgba(0, 212, 255, 0.16)' },
          '50%': { boxShadow: '0 0 24px rgba(0, 212, 255, 0.28)' },
        },
      },
    },
  },
