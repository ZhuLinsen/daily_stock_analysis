...
def normalize_analysis_context_pack_language(report_language: str = "zh") -> str:
    # Korean and German reuse the English structural context labels; the
    # model is constrained to the target output language via the analysis
    # output-language directive.
    return "en" if str(report_language or "").lower() in {"en", "ko", "de"} else "zh"
