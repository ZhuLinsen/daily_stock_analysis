    ...
    def screen(
        ...
        *,
        ...
        response = {
            ...
            "snapshot_requested_date": raw_data.get("snapshot_requested_date") or "",
            "snapshot_trade_date": raw_data.get("snapshot_trade_date") or "",
            "snapshot_non_trading_day": bool(raw_data.get("snapshot_non_trading_day")),
            ...
            "quality_gate_rejected_count": int(raw_data.get("quality_gate_rejected_count") or 0),
...
def _normalize_candidate(raw: Any, rank: int) -> Dict[str, Any]:
    ...
    return {
        ...
        "data_quality_score": _first_present(item, source, "data_quality_score"),
        "data_quality_flags": item.get("data_quality_flags") or source.get("data_quality_flags") or "",
