...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "GENERATION_BACKEND": {
        ...
        "description": "Generation method used by stock analysis, market reviews, and regular text generation. Provider API (LiteLLM) is the only integration path; local CLI backends were removed.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_BACKEND": {
        ...
        "description": "Choose how the ask-stock Chat runs. Auto keeps the current default-model route; Provider API (LiteLLM) is the only integration path.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_ORCHESTRATOR_TIMEOUT_S": {
        "title": "Agent Timeout",
        "description": "Shared timeout budget in seconds for Agent execution. Single-agent runs use it as the overall ReAct loop budget; multi-agent mode uses it as the cooperative pipeline budget. Set to 0 to disable on the default LiteLLM path.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
