...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "FUYAO_API_KEY": {
        "title": "TongHuaShun Fuyao API Key",
        "description": "Official TongHuaShun Fuyao financial data API key used by the AI stock workbench fast provider.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 12,
        "help_key": "settings.data_source.FUYAO_API_KEY",
        "examples": ["FUYAO_API_KEY=your_fuyao_api_key"],
        "docs": [
            {"label": "同花顺金融数据 API 文档", "href": "https://fuyao.aicubes.cn/llms.txt"},
        ],
        "warning_codes": ["secret_value"],
    },
    "MX_APIKEY": {
        "title": "EastMoney Miaoxiang API Key",
        "description": "EastMoney Miaoxiang Skills API key. Used only on the server side by mx_* Agent tools and provider debug APIs.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "examples": ["MX_APIKEY=your_miaoxiang_api_key"],
        "docs": [
            {"label": "东方财富妙想 Skills 安装指南", "href": "https://marketing.dfcfw.com/res/download/A620260623NIYC2U.md"},
        ],
        "warning_codes": ["secret_value"],
    },
