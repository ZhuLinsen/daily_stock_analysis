...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DISCORD_WEBHOOK_USERNAME": {
        ...
        "description": "Display name used for Discord Webhook messages. Limited to 80 characters.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "A股分析机器人",
        "options": [],
        "validation": {"pattern": r"^.{0,80}$"},
        "display_order": 33,
        "help_key": "settings.notification.chat_bots",
        "examples": ["DISCORD_WEBHOOK_USERNAME=美股收盘助手"],
        "docs": [
            {
                "label": "完整指南：Discord",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#discord",
    ...
    "DISCORD_WEBHOOK_AVATAR_URL": {
        ...
        "description": "Publicly accessible HTTPS image URL used as the Discord Webhook avatar.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://picsum.photos/200",
        "options": [],
        "validation": {"item_type": "url", "allowed_schemes": ["https"]},
        "display_order": 33,
        "help_key": "settings.notification.chat_bots",
        "examples": ["DISCORD_WEBHOOK_AVATAR_URL=https://example.com/bot-avatar.png"],
        "docs": [
            {
                "label": "完整指南：Discord",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#discord",
