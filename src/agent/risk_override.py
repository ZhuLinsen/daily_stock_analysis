...
class RiskOverrideApplication:
    """The runtime effect produced by applying a risk plan."""

    applied: bool
    from_signal: Optional[str]
    to_signal: Optional[str]
    reason: str
...
def build_risk_override_plan(
    ...
    *,
    ...
    """Build the single source of truth for risk override execution."""
