...
先启动并登录 Futu OpenD，再在当前 Python 环境安装 SDK。[安装 Futu OpenAPI SDK](https://openapi.futunn.com/futu-api-doc/en/intro/intro.html)：
