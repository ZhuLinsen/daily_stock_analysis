...
- [新功能] Web 设置页「快速添加渠道」新增 OrcaRouter OpenAI-compatible 预设（`orcarouter`，Base URL `https://api.orcarouter.ai/v1`），并同步补齐 `.env.example` 示例、`00-daily-analysis.yml` 渠道 env 映射与 LLM 服务商文档。
