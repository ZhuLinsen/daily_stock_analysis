...
- [文档] 记录 Agent `/chat/stream` progress event 契约，说明新增 `stage_start`、`stage_done`、`pipeline_timeout` 的字段语义、Web 兼容边界、验证方式、回滚方式，以及本变更不触及 provider/model/Base URL 或运行时配置迁移语义。
