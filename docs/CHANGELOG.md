...
- [新功能] `LLM_CHANNELS` 新增 `atlas_cloud` OpenAI-compatible 渠道预设，默认使用 `https://api.atlascloud.ai/v1` 与 `deepseek-ai/deepseek-v4-pro`，并兼容 `ATLAS_CLOUD_API_KEY(S)` / `ATLASCLOUD_API_KEY(S)` 环境变量别名。
