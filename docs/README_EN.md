...
| Social Sentiment | [Stock Sentiment API](https://api.adanos.org/docs) for Reddit / X / Polymarket, plus [Xquik](https://docs.xquik.com) for recent per-ticker X posts, US stocks only |
