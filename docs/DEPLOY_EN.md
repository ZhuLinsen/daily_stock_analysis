...
| `STOCK_LIST` | Watchlist | Comma-separated stock codes; registered-index explicit forms (e.g. `sh000016`, `930606.CSI`, `sz399365`) are also supported — see [Index watchlist configuration](full-guide_EN.md#index-watchlist-configuration) |
